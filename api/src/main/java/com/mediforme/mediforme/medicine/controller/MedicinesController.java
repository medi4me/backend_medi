package com.mediforme.mediforme.medicine.controller;
...
import com.mediforme.mediforme.search.application.MedicineSearchService;
...
public class MedicinesController {
    ...
    @GetMapping
    public ApiResponse<MedicineSearchResponseDto> searchByItemName(
        @RequestParam("name") @NotBlank String name
    ) {
        return ApiResponse.onSuccess(medicineSearchService.searchByName(name));
    }
